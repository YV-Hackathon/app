...
class _ApiClient implements ApiClient {
  ...
  Future<OnboardingSubmissionResponse> submitOnboarding(
      OnboardingSubmissionRequest request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = request;
    final _options = _setStreamType<OnboardingSubmissionResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<SermonRecommendationResponse> getRecommendations(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<SermonRecommendationResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<SermonPreferenceResponse> submitSermonPreference(
      SermonPreferenceRequest request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = request;
    final _options = _setStreamType<SermonPreferenceResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<ChurchRecommendationsResponse> getChurchRecommendations(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ChurchRecommendationsResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
        .compose(
          _dio.options,
          '/api/v1/church-recommendations/recommendations/${userId}',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ChurchRecommendationsResponse _value;
    try {
      _value = ChurchRecommendationsResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<ChurchModel> getChurch(int churchId) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ChurchModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ChurchModel _value;
    try {
      _value = ChurchModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<List<FeaturedSermonItem>> getFeaturedSermons(int churchId) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<FeaturedSermonItem>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
        .compose(
          _dio.options,
          '/api/v1/featured-sermons/churches/${churchId}/featured-sermons',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<FeaturedSermonItem> _value;
    try {
      _value = _result.data!
          .map((dynamic i) =>
              FeaturedSermonItem.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
